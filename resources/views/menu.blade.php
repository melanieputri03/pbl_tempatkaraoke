<?php
// Nama File: menu.php
// Deskripsi: Halaman ini menampilkan daftar produk kue yang dapat dibeli oleh pengguna. Pengguna dapat melakukan 
...
session_start(); // Memulai sesi untuk melacak status pengguna

// Memeriksa apakah pengguna memiliki role sebagai 'pembeli'. Jika tidak, arahkan ke halaman login.
...
// Mengambil nilai pencarian (search) jika ada dari URL
...
// Menjalankan query untuk mendapatkan data kue
...
<body style="background-color: #FFF8F8">
    ...
    <nav class="navbar">
        ...
        <div class="main-content">
            <h4 class="text-center fw-bold my-4">Daftar Kue</h4>
            <div class="row">
                <?php
